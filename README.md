...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xyvu9-q.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xyvu9-q.containers.anotherwebservice.com/
...
```
git clone git@github.com:sandwitcherz/container-xyvu9-q.git
cd container-xyvu9-q
```
...
```
docker attach container-xyvu9-q
```
